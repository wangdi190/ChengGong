// CMonitorError.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CCMonitorErrorApp, CWinApp)
	//{{AFX_MSG_MAP(CCMonitorErrorApp)
...
/////////////////////////////////////////////////////////////////////////////
// CCMonitorErrorApp construction

CCMonitorErrorApp::CCMonitorErrorApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CCMonitorErrorApp object

CCMonitorErrorApp theApp;
BOOL threadQuit;


BOOL CCMonitorErrorApp::InitInstance() 
{
...
void WINAPI DfDrawDemo(HDC hdc,RECT rt,DWORD style,char *buf)
{
	...
	dc.TextOut(rt.right/2, rt.bottom/2, "程序错误监视页面2013");
	dc.Detach();
}
...
void* QueryRecord(char* pszTable, char* pszWhere,int &num,char* pszDB)
{
	...
	if(pszWhere!=NULL)
	{
		...
		int error;
		char* pRec=(char*)LSI_QueryRecord(chSql,num,error,TRUE);
