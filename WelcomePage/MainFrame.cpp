...
/*	m_capbitmap.LoadBitmap(IDB_BACK_BMP);//IDB_CAPTION_BMP);
	BITMAP bitmap;
...
/*	CRect rect;
	...
	//粘贴双缓冲
/*	dc.StretchBlt(0, 0, rect.Width(), rect.Height(), &m_memdc, 0, 0, bitmap.bmWidth, bitmap.bmHeight, SRCCOPY);//SRCCOPY);
//	dc.BitBlt(0, 0, bitmap.bmWidth, bitmap.bmHeight, &m_memdc, 0,0,SRCCOPY);
