...
public:
	...
	int CopyV5Data(BASE0&bs,char *lp);
	int GetV5Size(BASE0&bs,int mode=0);
	FileV30();
	virtual ~FileV30();
private:
	...
	void SysPieToV5(void *data, void *lp);
	void MttextToV5(void *data, void *lp);
	void ZoneToV5(void *data, void *lp);
	void PctToV5(void *data, void *lp);
	void FlashToV5(void *data, void *lp);
	void ActToV5(void *data, void *lp);
	void BusToV5(void *data, void *lp);
	void ConlToV5(void *data, void *lp);
	void FlowToV5(void *data, void *lp);
	void SelfToV5(void *data, void *lp);
	void PushToV5(void *data, void *lp);
	void ScrtxtToV5(void *data, void *lp);
	void GifToV5(void *data, void *lp);
	void DateToV5(void *data, void *lp);
	void PieToV5(void *data, void *lp);
	void BarToV5(void *data, void *lp);
	void ElegToV5(void *data, void *lp);
	void YBToV5(void *data, void *lp);
	void AnlToV5(void *data, void *lp);
	void ReservoirToV5(void *data, void *lp);
	void PicToV5(void *data, void *lp);
	void Meter1ToV5(void *data, void *lp);
	void Meter2ToV5(void *data, void *lp);
	void Meter3ToV5(void *data, void *lp);
	void Meter4ToV5(void *data, void *lp);
	void PathToV5(void *data, void *lp);
	void SpicToV5(void *data, void *lp);
	void TableToV5(void *data, void *lp);
	void CoordToV5(void *data, void *lp);
	void MBoardToV5(void *data, void *lp);
	void SiteToV5(void *data, void *lp);
	void TextToV5(void *data, void *lp);
	void GlassToV5(void *data, void *lp);
	void ArrowToV5(void *data, void *lp);
	void ArcToV5(void *data, void *lp);
	void SinToV5(void *data, void *lp);
	void HsinToV5(void *data, void *lp);
	void RectToV5(void *data, void *lp);
	void DbxToV5(void *data,void *lp);
	void ConvertDataToV5(void *data,void *lp,int type);
};
